...
# People you've worked with: Tahmeed, Gillian
...
class Student():
    ...
    def write_programs(self, val = 1):
        self.num_programs = self.num_programs + val
...
programmers = [Student(i,j,k) for i,j,k in student_tups_list]
...
names_with_not_too_much_seniority = list([student.name for student in programmers if len(student.name) > student.years_UM])
